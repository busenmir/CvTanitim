...
class projeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val eleman1 = ProjeModel(1,"Sosyal Fayda İçin\n"+ "Veri Bilimi",R.drawable.mobil,"https://cads.tedu.edu.tr/projeler-hareketlilik-ve-mobilite/")
        val eleman2 = ProjeModel(2,"SüperKahramanlar",R.drawable.siper,"https://github.com/busenmir/SuperKahramanKitabi.git")
        val eleman3 = ProjeModel(3,"Veteriner \n Uygulaması",R.drawable.vet1,"https://github.com/busenmir/VeterinerUygulamasi")
        val eleman4 = ProjeModel(4,"Yemek Tarifleri",R.drawable.yemektarifi,"https://github.com/busenmir/YemekTarifleri")
        val eleman5= ProjeModel(5,"Zar Atmaca",R.drawable.zar,"https://github.com/busenmir/ZarAtma")
        val eleman6= ProjeModel(6,"Sayi Tahmin Oyunu ",R.drawable.sayi,"https://github.com/busenmir/SayiTahminEt")
        val eleman7= ProjeModel(7,"Daha Fazlası İçin \n Beklemede Kalın ! ",R.drawable.github,"https://github.com/busenmir?tab=repositories")
        liste = ArrayList<ProjeModel>()
        liste.add(eleman1)
        liste.add(eleman2)
        liste.add(eleman3)
        liste.add(eleman4)
