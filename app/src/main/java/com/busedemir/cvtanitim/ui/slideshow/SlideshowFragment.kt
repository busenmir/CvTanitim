...
class SlideshowFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val eleman3 = Model2(3,R.drawable.bayrak, "Kendi bünyelerinde geliştirdikleri projede yazılım ekibi takım çalışmasında görev aldım.Bootstrap,wordpress,css,html üzerinde çalışmalar yaptım. Bunun yanı sıra bir takım çalışmasında görevlendirmede ve takım olarak ilerleme iş dağılımı planlama kısımlarında tecrübe kazandım.\n" +
        ...
        val eleman4 = Model2(4,R.drawable.code,"2 bin başvuru içerisinden seçilen 30 kişilik bir grup ile Ted üniversitedi Uygulamalı veri bilimi merkezi öğretim üyeleri beraberinde Python programlama dili ile veri bilimini her dal içerisinde inceleyerek\n" +
        ...
        val eleman6 = Model2(6,R.drawable.akbank,"Upschool ve Akbank işbirliği ile Android Bootcamp Öğrencisi olarak yer almaktayım. Seçilen öğrenciler ile 3 aylık yoğunlaştırılmış Android eğitimidir.","UpSchool-Akbank Android Developer","Kullanılan Teknolojiler: Android \n Kotlin ,Java")
